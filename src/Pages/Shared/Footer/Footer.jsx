...
function Footer() {
  return (
    <div className=" mt-8 md:mt-10 lg:mt-12  font-lato">
      <footer className="bg-[#1D232A] rounded-t-lg">
            ...
            <div className="flex -mx-2">
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M18.255 3h3.68l-7.98 9.067L23.5 21h-6.407l-4.996-6.228L6.33 21H2.648l8.505-9.653L.5 3h6.59l4.586 5.722L18.255 3zm-1.134 16.125h1.975L7.01 4.76H4.882l12.239 14.365z" />
                </svg>
              </a>
            </div>
          </div>
