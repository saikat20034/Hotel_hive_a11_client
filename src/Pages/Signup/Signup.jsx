...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-200 m-10 mt-10 rounded-lg p-10">
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-2xl mt-10">
